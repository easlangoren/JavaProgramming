...
public class CapitalOne {
    public static void main(String[] args) {
        ...
        double max = employees[0].salary; // bu sadece maas olarak kiyaslamamizi sagliyor.
        ...
        System.out.println("How many employee is full time = " + countFullTime);
        System.out.println("How mant employee is part-time = " + countPartTime);
