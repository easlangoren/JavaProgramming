...
public class MyOffers {
    public static void main(String[] args) {
       ...
       // yukarda olusturulan objectlerin icinden sadece company name veya localOffer lari cagirmak istiyorsak loop oluturmaliyiz.

        for (Offer each : localOffers) {
            System.out.println(each.companyName+", salary:"+ each.salary); // bu sekilde her birini kendi icindeki variableini cagirmis oluyoruz.
