...
public class BankAccount {
    ...
    public void deposit (double amount){ // bunu bu sekilde olusturabiliyoruz, deposit methodu cagirdigimizda bir amount girmemizi isteyecek.

        if (amount<=0){
            System.out.println("Depositing amount can not be zero or negative");
            return; // in order to exit the method
        }
        balance+= amount;
    }
