...
public class AmazonInc {
    ...
    public static void main(String[] args) {
        ...
        Testerr tester1=new Testerr("Chinara",32,'F',"QA",1415,125000,company);

        Testerr tester2=new Testerr("Yasaman",31,'F', "QE",1416,130000,company);

        Testerr tester3=new Testerr("Irena",29,'F',"SDET",1417,128000,company);

        Testerr tester4=new Testerr("Cihad",26,'M',"QA",1418,125000,company);
        Testerr[] testers={tester1,tester2,tester3,tester4};
        ...
        for (Testerr tester : scrumTeam.testers) {
