...
public class BreakfastTasks {
    ...
    public static void main(String[] args) {
        ...
        domains("Cydeo.School@amazon.com");
    ...
    public static void domains(String enteredEmail) { // Cydeo.School@gmail.com

        String emailDomain = enteredEmail.substring(enteredEmail.indexOf("@") + 1, enteredEmail.lastIndexOf("."));
    ...
    public static void nameOfTheDay(int day){
        ...
        if (day<=7 && day>=1 ){
            weekDays = (day==1)? "Monday":(day==2)?"Tuesday":(day==3)?"Wednesday":(day==4)?"Thurday":(day==5)?"Friday":(day==6)?"Saturday":"Sunday";
    ...
    public static void daysInMonth(int number) {
        ...
        if (number <= 12 && number >= 1) {
            days = (number == 2) ? "28" : (number == 4 || number == 6 || number == 9 || number == 11) ? "30" : "31";
